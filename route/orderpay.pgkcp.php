...
if($debug != "true") {
	// 필수 항목 체크
	$required_fields = array("pay_method_alias", "good_name", "buyr_name", "buyr_mail", "buyr_tel1", "chk_agree");
...
$payinfo['use_pay_method_alias'] = $payinfo['pay_method_alias'];
...
$jsloader->add_scripts(get_webproxy_url($g_conf_js_url, "nocache"));
