<?php
    ...
    /* ============================================================================== */
    $g_conf_home_dir  = get_current_working_dir() . "/vendor/pgkcp";       // BIN 절대경로 입력 (bin전까지)
    ...
    /* =   log 경로 지정                                                            = */
    /* ============================================================================== */
    $g_conf_log_path = get_current_working_dir() . "/storage/logs/pgkcp";
    ...
    /* ============================================================================== */
    $g_conf_site_name = "ReasonableFramework";
